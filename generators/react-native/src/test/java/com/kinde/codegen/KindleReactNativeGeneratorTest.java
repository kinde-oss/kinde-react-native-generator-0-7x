 ...
 * KindleReactNativeGenerator.java in the postProcessOperationsWithModels() method. 2) To launch
 * this test in Eclipse: right-click | Debug As | JUnit Test
 *
 */
public class KindleReactNativeGeneratorTest {
  ...
  public void launchCodeGenerator() {
    ...
    // to understand how the 'openapi-generator-cli' module is using 'CodegenConfigurator', have a
    // look at the 'Generate' class:
    // https://github.com/OpenAPITools/openapi-generator/blob/master/modules/openapi-generator-cli/src/main/java/org/openapitools/codegen/cmd/Generate.java
    final CodegenConfigurator configurator =
        new CodegenConfigurator().setGeneratorName("kinde-react-native") // use this codegen library
            .setInputSpec("../../modules/openapi-generator/src/test/resources/2_0/petstore.yaml") // sample
            // OpenAPI
            // file
            ...
            // // or from the server
            .setOutputDir("out/kinde-react-native"); // output directory
